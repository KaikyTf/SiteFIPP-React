...
import { Title, Wrapper, Image, FormGroup, FormLabel, Input, SubmitButton, Form} from "./duvidas.styles";
...
export const Duvidas = () => {
    ...
    const handleSendClick = async (event: {preventDefault: () => void; }) => {
        ...
        const sheetDBUrl = "https://sheetdb.io/api/v1/pqig5m9rt8rkg";
        const payload = {
            Nome: name,
            Email: email,
            Duvidas: question,
        ...
        try{
            ...
            console.error('Erro ao enviar para o sheetDB')
        }
